using Smartstore.FatturazioneElettronica.XML.FatturaElettronicaHeader.DatiTrasmissione;
    ...
    public class DatiTrasmissioneValidator : AbstractValidator<DatiTrasmissione>
    {
        public DatiTrasmissioneValidator()
        {
            ...
            RuleFor(dt => dt.FormatoTrasmissione)
                .NotEmpty()
                .SetValidator(new IsValidValidator<DatiTrasmissione, FormatoTrasmissione>())
                .WithErrorCode("00428");
