        ...
        AbstractValidator<DatiAnagraficiCedentePrestatore>
    {
        public DatiAnagraficiCedentePrestatoreValidator()
        {
            ...
            RuleFor(x => x.ProvinciaAlbo)
                .SetValidator(new IsValidValidator<DatiAnagraficiCedentePrestatore, Provincia>())
            ...
            RuleFor(x => x.RegimeFiscale)
                .NotEmpty()
                .SetValidator(new RegimeFiscaleValidator<DatiAnagraficiCedentePrestatore, Tabelle.RegimeFiscale>());
