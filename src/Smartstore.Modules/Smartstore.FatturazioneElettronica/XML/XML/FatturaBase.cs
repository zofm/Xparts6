...
namespace Smartstore.FatturazioneElettronica.XML
{
    public class FatturaBase : BaseClassSerializable
    {
        protected FatturaBase()
        {
        ...
        public static FatturaBase CreateInstance(Instance formato)
        {
            var f = new FatturaBase();
